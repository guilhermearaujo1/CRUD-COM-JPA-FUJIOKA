...
public class PopulaCliente {
	...
	public static void listarPreferencia() {
		...
		stringBuilder.append("Select * from preferencia");
		stringBuilder.append("INNER JOIN CLIENTE c ON p.IdCLIENTE_Id = c.ID ");
        stringBuilder.append("WHERE c.MATRICULA = :matricula");
        Query query = em.createNativeQuery(stringBuilder.toString(), Preferencia.class);
